...
d["table-0011-447"] = t8
d["table-0011-449"] = t9
d["table-1607-162"] = t10
d["table-0104-408"] = t11
d["table-0011-452"] = t12
d["table-1150-885"] = t13
d["table-0011-448"] = t14
d["table-1517-609"] = t15
d["table-0587-13"] = t16
d["table-1251-940"] = t17
d["table-1188-685"] = t18
d["table-1518-807"] = t19
d["table-0230-966"] = t20

# Writing or 'dumping' the data of each table into JSON file => "our new corpus"
with open('Corpus_Data/query_28.json', 'w') as f:
    json.dump(d, f)

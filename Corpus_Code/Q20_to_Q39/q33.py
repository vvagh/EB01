...
d["table-1442-709"] = t8
d["table-0290-545"] = t9
d["table-0259-373"] = t10
d["table-0215-300"] = t11
d["table-1400-611"] = t12
d["table-0837-624"] = t13
d["table-1203-97"] = t14
d["table-0814-469"] = t15
d["table-1201-576"] = t16
d["table-0977-706"] = t17
d["table-0814-494"] = t18
d["table-0791-515"] = t19
d["table-0814-443"] = t20

# Writing or 'dumping' the data of each table into JSON file => "our new corpus"
with open('Corpus_Data/query_33.json', 'w') as f:
    json.dump(d, f)

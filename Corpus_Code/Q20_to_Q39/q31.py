...
d["table-1550-209"] = t8
d["table-1550-196"] = t9
d["table-1287-861"] = t10
d["table-1550-999"] = t11
d["table-1565-676"] = t12
d["table-1594-912"] = t13
d["table-1565-710"] = t14
d["table-0017-237"] = t15
d["table-1550-207"] = t16
d["table-1550-201"] = t17
d["table-1551-19"] = t18
d["table-0730-628"] = t19
d["table-1550-200"] = t20

# Writing or 'dumping' the data of each table into JSON file => "our new corpus"
with open('Corpus_Data/query_31.json', 'w') as f:
    json.dump(d, f)

...
d["table-0830-358"] = t8
d["table-0498-297"] = t9
d["table-0458-601"] = t10
d["table-1007-467"] = t11
d["table-1176-644"] = t12
d["table-0209-363"] = t13
d["table-0103-625"] = t14
d["table-0333-158"] = t15
d["table-1579-470"] = t16
d["table-1407-668"] = t17
d["table-1587-825"] = t18
d["table-1226-910"] = t19
d["table-0339-698"] = t20

# Writing or 'dumping' the data of each table into JSON file => "our new corpus"
with open('Corpus_Data/query_23.json', 'w') as f:
    json.dump(d, f)

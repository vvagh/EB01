...
d["table-0636-282"] = t8
d["table-1051-457"] = t9
d["table-0397-592"] = t10
d["table-1051-395"] = t11
d["table-1628-977"] = t12
d["table-1628-974"] = t13
d["table-0397-591"] = t14
d["table-0552-213"] = t15
d["table-1628-976"] = t16
d["table-1628-971"] = t17
d["table-1628-969"] = t18		
d["table-1628-973"] = t19
d["table-1628-972"] = t20

# Writing or 'dumping' the data of each table into JSON file => "our new corpus"
with open('Corpus_Data/query_20.json', 'w') as f:
    json.dump(d, f)

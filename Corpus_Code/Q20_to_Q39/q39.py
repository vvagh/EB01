...
d["table-0806-57"] = t8
d["table-0191-235"] = t9
d["table-0217-467"] = t10
d["table-1420-265"] = t11
d["table-1390-133"] = t12
d["table-0806-54"] = t13
d["table-0285-770"] = t14
d["table-1631-302"] = t15
d["table-0919-677"] = t16
d["table-1253-980"] = t17
d["table-0136-378"] = t18
d["table-0752-77"] = t19
d["table-0752-76"] = t20

# Writing or 'dumping' the data of each table into JSON file => "our new corpus"

with open('Corpus_Data/query_39.json', 'w') as f:
    json.dump(d, f)

...
d["table-0450-569"] = t8
d["table-1460-55"] = t9
d["table-0972-522"] = t10
d["table-1289-998"] = t11
d["table-0867-339"] = t12
d["table-1371-959"] = t13
d["table-1106-217"] = t14
d["table-1598-562"] = t15
d["table-0290-355"] = t16
d["table-0349-205"] = t17
d["table-0679-737"] = t18
d["table-0144-887"] = t19
d["table-1547-182"] = t20

# Writing or 'dumping' the data of each table into JSON file => "our new corpus"
with open('Corpus_Data/query_32.json', 'w') as f:
    json.dump(d, f)
